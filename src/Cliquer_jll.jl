...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Cliquer_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("cb831320-0638-59bb-8a4c-9389d28549df"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Cliquer", artifacts_toml) for e in artifacts["Cliquer"]]
...
if best_platform === nothing
    @debug("Unable to load Cliquer; unsupported platform $(triplet(platform_key_abi()))")
else
